...
| [Bermuda Ble Trilateration](https://github.com/agittins/bermuda) |  [v0.8.0-rc1] | Bermuda Bluetooth/BLE Triangulation / Trilateration for HomeAssistant |[@agittins](https://github.com/agittins).|
...
| [F1 Sensor](https://github.com/Nicxe/f1_sensor) |  [v0.1.0] | A Home Assistant Custom Integration that provides information about the next Formula 1 race and the full season calendar |[@Nicxe](https://github.com/Nicxe).|
...
| [Spotifyplus](https://github.com/thlucas1/homeassistantcomponent_spotifyplus) |  [v1.0.113] | Home Assistant integration for Spotify Player control, services, and soundtouchplus integration support. |[@thlucas1](https://github.com/thlucas1).|
...
| [Team Tracker](https://github.com/vasqued2/ha-teamtracker) |  [v0.14.8] | Home Assistant integration that provides real-time scores in multiple professional (NBA, NFL, NHL, MLB, MLS, and more), college (NCAA), and international (soccer, golf, tennis, mma, racing) sports using ESPN APIs. |[@vasqued2](https://github.com/vasqued2).|
...
| [Atomic Calendar Revive](https://github.com/totaldebug/atomic-calendar-revive) |  [v10.0.1-beta.2] | An advanced calendar card for Home Assistant Lovelace. |
