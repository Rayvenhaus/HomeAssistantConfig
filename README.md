...
| [Dynamic Energy Cost](https://github.com/martinarva/dynamic_energy_cost) |  [v0.6.3] |  |[@martinarva](https://github.com/martinarva).|
...
| [Flightradar24](https://github.com/AlexandrErohin/home-assistant-flightradar24) |  [v1.25.1] | Flightradar24 integration for Home Assistant |[@AlexandrErohin](https://github.com/AlexandrErohin).|
...
| [Mediarr](https://github.com/Vansmak/mediarr_sensor) |  [v3.1.3] |  |[@vansmak](https://github.com/vansmak).|
...
| [Yahoo Finance](https://github.com/iprak/yahoofinance) |  [v1.2.14] | Home Assistant component which allows you to get stock updates from Yahoo finance. |[@iprak](https://github.com/iprak).|
</details>
...
| [Calendar Card Pro](https://github.com/alexpfau/calendar-card-pro) |  [v1.1.0] | 📅 A sleek and highly customizable calendar card for Home Assistant, designed for performance and a clean, modern look. |
...
| [Temperature Heatmap Card](https://github.com/zanac/temperature-heatmap-card) |  [v1.0.7] | Temperature Hetmap for Home Assistant heatmap |
...
| Music Assistant Server | 2.4.4 |  | d5369777 |
