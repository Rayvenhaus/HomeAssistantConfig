...
`;function xt(e){e.style.opacity="0",e.style.transition=`opacity ${Ne}ms ease-out`,setTimeout((()=>{e.parentNode&&(e.parentNode.removeChild(e),Be("Removed hold indicator"))}),Ne)}
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Et=1,Ot=2,Ct=e=>(...t)=>({_$litDirective$:e,values:t});class Pt{constructor(e){}get _$isConnected(){return this._$parent._$isConnected}_$initialize(e,t,n){this.__part=e,this._$parent=t,this.__attributeIndex=n}_$resolve(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}
/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const zt=Ct(class extends Pt{constructor(e){if(super(e),e.type!==Et||"class"!==e.name||e.strings?.length>2)throw new Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter((t=>e[t])).join(" ")+" "}update(e,[t]){if(void 0===this._previousClasses){this._previousClasses=new Set,void 0!==e.strings&&(this._staticClasses=new Set(e.strings.join(" ").split(/\s/).filter((e=>""!==e))));for(const e in t)t[e]&&!this._staticClasses?.has(e)&&this._previousClasses.add(e);return this.render(t)}const n=e.element.classList;for(const e of this._previousClasses)e in t||(n.remove(e),this._previousClasses.delete(e));for(const e in t){const i=!!t[e];i===this._previousClasses.has(e)||this._staticClasses?.has(e)||(i?(n.add(e),this._previousClasses.add(e)):(n.remove(e),this._previousClasses.delete(e)))}return ee}}),Mt="important",Nt=" !"+Mt;
/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Lt=Ct(class extends Pt{constructor(e){if(super(e),e.type!==Et||"style"!==e.name||e.strings?.length>2)throw new Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce(((t,n)=>{const i=e[n];return null==i?t:t+`${n=n.includes("-")?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${i};`}),"")}update(e,[t]){const{style:n}=e.element;if(void 0===this._previousStyleProperties)return this._previousStyleProperties=new Set(Object.keys(t)),this.render(t);for(const e of this._previousStyleProperties)null==t[e]&&(this._previousStyleProperties.delete(e),e.includes("-")?n.removeProperty(e):n[e]=null);for(const e in t){const i=t[e];if(null!=i){this._previousStyleProperties.add(e);const t="string"==typeof i&&i.endsWith(Nt);e.includes("-")||t?n.setProperty(e,t?i.slice(0,-11):i,t?Mt:""):n[e]=i}}return ee}}),{_ChildPart:It}=ge,At=window.ShadyDOM?.inUse&&!0===window.ShadyDOM?.noPatch?window.ShadyDOM.wrap:e=>e,jt=()=>document.createComment(""),Wt=(e,t,n)=>{const i=At(e._$startNode).parentNode,a=void 0===t?e._$endNode:t._$startNode;if(void 0===n){const t=At(i).insertBefore(jt(),a),o=At(i).insertBefore(jt(),a);n=new It(t,o,e,e.options)}else{const t=At(n._$endNode).nextSibling,o=n._$parent,r=o!==e;if(r){let t;n._$reparentDisconnectables?.(e),n._$parent=e,void 0!==n._$notifyConnectionChanged&&(t=e._$isConnected)!==o._$isConnected&&n._$notifyConnectionChanged(t)}if(t!==a||r){let e=n._$startNode;for(;e!==t;){const t=At(e).nextSibling;At(i).insertBefore(e,a),e=t}}}return n},Ut=(e,t,n=e)=>(e._$setValue(t,n),e),Ft={},Vt=e=>{e._$notifyConnectionChanged?.(!1,!0);let t=e._$startNode;const n=At(e._$endNode).nextSibling;for(;t!==n;){const e=At(t).nextSibling;At(t).remove(),t=e}},Rt=(e,t,n)=>{const i=new Map;for(let a=t;a<=n;a++)i.set(e[a],a);return i};
/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Jt=Ct(class extends Pt{constructor(e){if(super(e),e.type!==Ot)throw new Error("repeat() can only be used in text expressions")}_getValuesAndKeys(e,t,n){let i;void 0===n?n=t:void 0!==t&&(i=t);const a=[],o=[];let r=0;for(const t of e)a[r]=i?i(t,r):r,o[r]=n(t,r),r++;return{values:o,keys:a}}render(e,t,n){return this._getValuesAndKeys(e,t,n).values}update(e,[t,n,i]){const a=e._$committedValue;const{values:o,keys:r}=this._getValuesAndKeys(t,n,i);if(!Array.isArray(a))return this._itemKeys=r,o;const s=this._itemKeys??=[],l=[];let d,c,h=0,u=a.length-1,p=0,m=o.length-1;for(;h<=u&&p<=m;)if(null===a[h])h++;else if(null===a[u])u--;else if(s[h]===r[p])l[p]=Ut(a[h],o[p]),h++,p++;else if(s[u]===r[m])l[m]=Ut(a[u],o[m]),u--,m--;else if(s[h]===r[m])l[m]=Ut(a[h],o[m]),Wt(e,l[m+1],a[h]),h++,m--;else if(s[u]===r[p])l[p]=Ut(a[u],o[p]),Wt(e,a[h],a[u]),u--,p++;else if(void 0===d&&(d=Rt(r,p,m),c=Rt(s,h,u)),d.has(s[h]))if(d.has(s[u])){const t=c.get(r[p]),n=void 0!==t?a[t]:null;if(null===n){const t=Wt(e,a[h]);Ut(t,o[p]),l[p]=t}else l[p]=Ut(n,o[p]),Wt(e,a[h],n),a[t]=null;p++}else Vt(a[u]),u--;else Vt(a[h]),h++;for(;p<=m;){const t=Wt(e,l[m+1]);Ut(t,o[p]),l[p++]=t}for(;h<=u;){const e=a[h++];null!==e&&Vt(e)}return this._itemKeys=r,((e,t=Ft)=>{e._$committedValue=t})(e,l),ee}});function Ht(e,t){const n=st(t);return"loading"===e?Q`
