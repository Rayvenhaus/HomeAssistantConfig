 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Pt=1,Nt=2,Lt=e=>(...t)=>({_$litDirective$:e,values:t});class It{constructor(e){}get _$isConnected(){return this._$parent._$isConnected}_$initialize(e,t,n){this.__part=e,this._$parent=t,this.__attributeIndex=n}_$resolve(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}
/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const jt=Lt(class extends It{constructor(e){if(super(e),e.type!==Pt||"class"!==e.name||e.strings?.length>2)throw new Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter((t=>e[t])).join(" ")+" "}update(e,[t]){if(void 0===this._previousClasses){this._previousClasses=new Set,void 0!==e.strings&&(this._staticClasses=new Set(e.strings.join(" ").split(/\s/).filter((e=>""!==e))));for(const e in t)t[e]&&!this._staticClasses?.has(e)&&this._previousClasses.add(e);return this.render(t)}const n=e.element.classList;for(const e of this._previousClasses)e in t||(n.remove(e),this._previousClasses.delete(e));for(const e in t){const i=!!t[e];i===this._previousClasses.has(e)||this._staticClasses?.has(e)||(i?(n.add(e),this._previousClasses.add(e)):(n.remove(e),this._previousClasses.delete(e)))}return ee}}),At="important",Wt=" !"+At;
/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ft=Lt(class extends It{constructor(e){if(super(e),e.type!==Pt||"style"!==e.name||e.strings?.length>2)throw new Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce(((t,n)=>{const i=e[n];return null==i?t:t+`${n=n.includes("-")?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${i};`}),"")}update(e,[t]){const{style:n}=e.element;if(void 0===this._previousStyleProperties)return this._previousStyleProperties=new Set(Object.keys(t)),this.render(t);for(const e of this._previousStyleProperties)null==t[e]&&(this._previousStyleProperties.delete(e),e.includes("-")?n.removeProperty(e):n[e]=null);for(const e in t){const i=t[e];if(null!=i){this._previousStyleProperties.add(e);const t="string"==typeof i&&i.endsWith(Wt);e.includes("-")||t?n.setProperty(e,t?i.slice(0,-11):i,t?At:""):n[e]=i}}return ee}}),{_ChildPart:Ut}=ge,Vt=window.ShadyDOM?.inUse&&!0===window.ShadyDOM?.noPatch?window.ShadyDOM.wrap:e=>e,Rt=()=>document.createComment(""),Jt=(e,t,n)=>{const i=Vt(e._$startNode).parentNode,a=void 0===t?e._$endNode:t._$startNode;if(void 0===n){const t=Vt(i).insertBefore(Rt(),a),r=Vt(i).insertBefore(Rt(),a);n=new Ut(t,r,e,e.options)}else{const t=Vt(n._$endNode).nextSibling,r=n._$parent,o=r!==e;if(o){let t;n._$reparentDisconnectables?.(e),n._$parent=e,void 0!==n._$notifyConnectionChanged&&(t=e._$isConnected)!==r._$isConnected&&n._$notifyConnectionChanged(t)}if(t!==a||o){let e=n._$startNode;for(;e!==t;){const t=Vt(e).nextSibling;Vt(i).insertBefore(e,a),e=t}}}return n},Ht=(e,t,n=e)=>(e._$setValue(t,n),e),Bt={},Kt=e=>{e._$notifyConnectionChanged?.(!1,!0);let t=e._$startNode;const n=Vt(e._$endNode).nextSibling;for(;t!==n;){const e=Vt(t).nextSibling;Vt(t).remove(),t=e}},Yt=(e,t,n)=>{const i=new Map;for(let a=t;a<=n;a++)i.set(e[a],a);return i};
/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const qt=Lt(class extends It{constructor(e){if(super(e),e.type!==Nt)throw new Error("repeat() can only be used in text expressions")}_getValuesAndKeys(e,t,n){let i;void 0===n?n=t:void 0!==t&&(i=t);const a=[],r=[];let o=0;for(const t of e)a[o]=i?i(t,o):o,r[o]=n(t,o),o++;return{values:r,keys:a}}render(e,t,n){return this._getValuesAndKeys(e,t,n).values}update(e,[t,n,i]){const a=e._$committedValue;const{values:r,keys:o}=this._getValuesAndKeys(t,n,i);if(!Array.isArray(a))return this._itemKeys=o,r;const s=this._itemKeys??=[],l=[];let d,c,h=0,u=a.length-1,p=0,m=r.length-1;for(;h<=u&&p<=m;)if(null===a[h])h++;else if(null===a[u])u--;else if(s[h]===o[p])l[p]=Ht(a[h],r[p]),h++,p++;else if(s[u]===o[m])l[m]=Ht(a[u],r[m]),u--,m--;else if(s[h]===o[m])l[m]=Ht(a[h],r[m]),Jt(e,l[m+1],a[h]),h++,m--;else if(s[u]===o[p])l[p]=Ht(a[u],r[p]),Jt(e,a[h],a[u]),u--,p++;else if(void 0===d&&(d=Yt(o,p,m),c=Yt(s,h,u)),d.has(s[h]))if(d.has(s[u])){const t=c.get(o[p]),n=void 0!==t?a[t]:null;if(null===n){const t=Jt(e,a[h]);Ht(t,r[p]),l[p]=t}else l[p]=Ht(n,r[p]),Jt(e,a[h],n),a[t]=null;p++}else Kt(a[u]),u--;else Kt(a[h]),h++;for(;p<=m;){const t=Jt(e,l[m+1]);Ht(t,r[p]),l[p++]=t}for(;h<=u;){const e=a[h++];null!==e&&Kt(e)}return this._itemKeys=o,((e,t=Bt)=>{e._$committedValue=t})(e,l),ee}});function Gt(e,t){const n=lt(t);return"loading"===e?Q`
